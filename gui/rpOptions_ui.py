...
class Ui_rpOptions(QtWidgets.QWidget):
    ...
    def setupUi(self, rpWidget):
        ...
        l2 = QtGui.QLabel("T-pre: ")
        l3 = QtGui.QLabel("T-post: ")
        l4 = QtGui.QLabel("Sampling Period: ")
        ...
        self.ggl.addWidget(l2, 0, 5, 1, 1)
        self.ggl.addWidget(self.timePre, 1, 5, 1, 1)
        self.ggl.addWidget(l3, 0, 6, 1, 1)
        self.ggl.addWidget(self.timePost, 1, 6, 1, 1)
        self.ggl.addWidget(l4, 0, 7, 1, 2)
        self.ggl.addWidget(self.samplingPeriod, 1, 7, 1, 2)
